...
public class HTTPConnection {
     ...
     * @throws Exception readErrorStream() will throw Exception to log and notify the user
     */
    public void readErrorStream(HttpURLConnection http, int responseCode) throws Exception {
        ...
        if (http.getResponseCode() >= responseCode) {
            ...
            throw new ConnectException("HTTP response: " + errorBody);
        }
    }
}